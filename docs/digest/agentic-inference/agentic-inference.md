...
We have also invested in day-0 tool call and reasoning parsing support for various open-source models. If you find that a model is not supported, please [open an issue](https://github.com/ai-dynamo/dynamo/issues) or use the [tool-call-parser-generator](../../../skills/tool-parser-generator/SKILL.md) skill to generate it with your harness of choice.
